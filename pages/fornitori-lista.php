            ...
            <div class="portlet light portlet-fit portlet-datatable" style="margin-top:-70px;background-color:transparent">
                <div class="portlet-title">
                    <!--<div class="caption">
                        ...
                        <span class="caption-subject font-green sbold uppercase">fornitori</span>
                    </div>-->
                    <div class="actions">
                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-hover" id="sample_3">
                            <thead>
                                <tr>
                                    <th> <i class="fa fa-briefcase"></i> Nome Fornitore </th>
                            ...
                            <tbody>
                                ...
                                $fornitori = $DB_CON->query("SELECT * FROM  `fornitori` ");
                                
                                foreach ($fornitori as $fornitore) {
                                    print '<tr>';
                                    print '<td> <a href="?page=fornitori-scheda&id='. $fornitore[0] .'">' . $fornitore[1] . '</a></td>';
                                    print '<td> <a href="#">'. $fornitore[2] .' </a></td>';
                                    print '<td> <a href="tel:'. $fornitore[8] .'"> '. $fornitore[8] .'</a></td>';
                                    print '<td class="hidden-xs"> <a href="mailto:' . $fornitore[7] . '"> ' . $fornitore[7] . '</a></td>';
                                    print '<td class="hidden-sm hidden-xs"> ' . $fornitore[3] . ' - ' . $fornitore[4] . ' ' . $fornitore[5] . '</td>';
                                    print '</tr>';
                                }
