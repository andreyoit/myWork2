                ...
                <div class="portlet-body">
                    <div class="table-container">
                        <table class="table table-striped table-hover" id="sample_3">
                            <thead>
                                <tr>
                                    <th> <i class="fa fa-briefcase"></i> Nome Cliente </th>
                            ...
                            <tbody>
                                ...
                                $clienti = $DB_CON->query("SELECT * FROM  `clienti` ");
                                
                                foreach ($clienti as $cliente) {
                                    print '<tr>';
                                    print '<td> <a href="?page=clienti-scheda&id='. $cliente[0] .'">' . $cliente[1] . '</a></td>';
                                    print '<td> <a href="#">'. $cliente[2] .' </a></td>';
                                    print '<td> <a href="tel:'. $cliente[8] .'"> '. $cliente[8] .'</a></td>';
                                    print '<td class="hidden-xs"> <a href="mailto:' . $cliente[7] . '"> ' . $cliente[7] . '</a></td>';
                                    print '<td class="hidden-sm hidden-xs"> ' . $cliente[3] . ' - ' . $cliente[4] . ' ' . $cliente[5] . '</td>';
                                    print '</tr>';
                                }
